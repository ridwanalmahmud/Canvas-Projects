window.addEventListener("load",()=>{
  ...
  class Effect{
    ...
    wrapText(text){
      const gradient1 = this.context.createLinearGradient(0, 0, this.canvasWidth, this.canvasHeight);
      gradient1.addColorStop(0.3,"violet");
      gradient1.addColorStop(0.5,"purple");
      gradient1.addColorStop(0.7,"pink");
